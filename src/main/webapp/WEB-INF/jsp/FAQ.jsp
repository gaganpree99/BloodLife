	...
	<div class="wrap">
		...
		<div class="">
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-12 col-md-7 col-lg-7 text-centers card"
						style="height: 600px; overflow: scroll">
						<div class="card-body frequenQ">
							...
							<ul>
								...
								<li>
									...
									<p>The screening process is lengthy and may seem intrusive,
										...
										transmitting infections through their blood. The criteria we
										use to determine donor eligibility are based on scientific
								...
								<li>
									...
									<p>While we test every donation using sophisticated and
										...
										current tests cannot detect signs of a virus. Advances in
										testing technology have reduced but not eliminated these
								...
								<li>
									...
									<p>
										...
										ways you can help if you want to get involved with Canadian
										Blood Services before you turn 17. Find out how to become a
										volunteer or organize a high-school blood clinic by emailing
								...
								<li>
									...
									<p>
										...
										Children under 10 and their supervisor are welcome to wait in
										the refreshment area and enjoy a snack while they wait for
										their hero/donor. We ask that children in our clinics be
										supervised by a person who is at least 12 years of age.<br>
										<br> Children aged 10 and older are welcome to wait in
										the refreshment or designated waiting areas without
										supervision.<br> <br> Please ensure those joining
					...
					<div class="col-sm-12 col-md-4 col-lg-4 text-centers card my-auto"
						style="height: 600px;">
						<div class="align-items-center col-md-12 col-lg-12  my-auto">
							<div class="container ">
								<div class="row center  my-auto">
									...
									<h1>Query submitted successfully</h1><br>
															<p> Your token id is: <span id="resultToken"></span> and the same has  been sent to
															<span id="resultEmail"></span></p>
														<br>	<p>Our team will get back to you shortly</p>
														<p>Have more queries? <span><a id="resultBack" href="">Back</a></span></p>
									</div>
								</div>
							</div>
						</div>
